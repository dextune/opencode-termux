...
#
# VERSION FREEZE
#   This installer is frozen for opencode-ai 1.17.15. The binary patches
#   (ELF interpreter path, file descriptor wiring, etc.) only apply to
#   the exact build of `opencode-linux-arm64@1.17.15`. Newer or older
